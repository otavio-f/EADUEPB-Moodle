...
Step 1: The Database
  Restore the database dump file (eaduepb_moodlecloud.sql) to your postgresql server using the pg_restore command
  Example: pg_restore --disable-triggers -d database_name -h database_host -n public -U database_user -O -x eaduepb_moodlecloud.sql
...
Step 3: Get The Moodle Code
  ...
  Example: git clone -b MOODLE_31_STABLE git://git.moodle.org/moodle.git
